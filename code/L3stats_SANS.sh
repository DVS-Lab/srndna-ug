...
OUTPUT=${MAINOUTPUT}/L3_task-${task}_${REPLACEME}_cnum-${cnum_pad}_cname-${copename}_twogroup_wCovs_in-out_sensitivity
...
#	ITEMPLATE=${maindir}/templates/L3_template_n${N}_${task}_twogroup_wCovs.fsf
	...
	ITEMPLATE=${maindir}/templates/L3_template_n${N}_${task}_twogroup_wCovs_in-out_sensitivity.fsf
	OTEMPLATE=${MAINOUTPUT}/L3_task-${task}_${REPLACEME}_copenum-${copenum}_twogroup_wCovs_in-out_sensitivity.fsf
